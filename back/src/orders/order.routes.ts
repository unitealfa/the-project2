...
import { syncOfficialStatuses, updateOrderStatus, getDeliveryPersons, getDeliveryPersonOrders, getDeliveryPersonHistory, generateBordereauPDF } from './order.controller';
